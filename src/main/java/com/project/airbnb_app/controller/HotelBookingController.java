...
public class HotelBookingController {
    ...
    ResponseEntity<Map<String, String>> cancelBooking(@PathVariable Long bookingId) {
        hotelBookingOrchestratorService.cancelBooking(bookingId);
    ...
    public ResponseEntity<HotelBookingDto> createBooking(@Valid @RequestBody HotelBookingRequest hotelBookingRequest) {
        HotelBookingDto hotelBookingDto = hotelBookingOrchestratorService.createHotelBooking(hotelBookingRequest);
    ...
    public ResponseEntity<Map<String, String>> initiatePayment(@PathVariable Long bookingId) {
        String paymentSessionUrl = hotelBookingOrchestratorService.initiatePayment(bookingId);
